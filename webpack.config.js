...
module.exports = {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            { from: path.join(__dirname, 'node_modules', 'react-nouislider', 'example'), to: path.join(__dirname, "dist", "react-nouislider", "example") }
        ]),
        new LoaderOptionsPlugin({
            ...
            options: {
                postcss: {
                    plugins: [
                      require('postcss-prefix-selector')({prefix: '.MapStore2-examples', exclude: ['.ms2', '.MapStore2-examples', '[data-ms2-container]']})
                    ]
                },
                context: __dirname
            }
