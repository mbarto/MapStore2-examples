...
webpackConfig.plugins = [
    ...
    new LoaderOptionsPlugin({
        ...
        options: {
            postcss: {
                plugins: [
                  require('postcss-prefix-selector')({prefix: '.MapStore2-examples', exclude: ['.MapStore2-examples', '.ms2', '[data-ms2-container]']})
                ]
            },
            context: __dirname
        }
...
webpackConfig.output.publicPath = "/MapStore2-examples/dist/";
